...
spec = do
  ...
  describe "parseDumpFile1" $
    it "should parse" $ do
      res <- parseDumpFile "data/STM32F103xx.dump"
      res `shouldBe` (Address 0x40021000 , testData1)

  describe "parseDumpFile2" $
    it "should parse" $ do
      res <- parseDumpFile "data/STM32F107xx.dump"
      res `shouldBe` (Address 0x40021000 , testData2)
...
testData2 =
  [
    0x83 ,  0x65 ,  0x00 ,  0x04 ,  0x00 ,  0x00 ,  0x00 ,  0x00
  , 0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00
  , 0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x14 ,  0x00 ,  0x00 ,  0x00
  , 0x7d ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00
  , 0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x1c
  , 0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x44 ,  0x66 ,  0x01 ,  0x00
  , 0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00 ,  0x00
  ]
